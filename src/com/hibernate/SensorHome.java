...
public class SensorHome {
	...
	public Sensor merge(Sensor detachedInstance) {
		...
		try {
			Sensor result = (Sensor) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Sensor findById(java.lang.String id) {
		...
		try {
			Sensor instance = (Sensor) sessionFactory.getCurrentSession().get("Sensor", id);
			if (instance == null) {
	...
	public List findByExample(Sensor instance) {
		log.debug("finding Sensor instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Sensor").add(Example.create(instance))
					.list();
