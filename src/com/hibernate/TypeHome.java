...
public class TypeHome {
	...
	public Type findById(java.lang.Integer id) {
		...
		try {
			Type instance = (Type) sessionFactory.getCurrentSession().get("Type", id);
			if (instance == null) {
	...
	public List findByExample(Type instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("Type").add(Example.create(instance))
					.list();
